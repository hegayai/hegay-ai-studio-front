  ...
  return (
    <SystemShell>
      <div className="space-y-10">
        ...
        <div>
          <h1 className="brand-title text-4xl mb-2">Vision Studio</h1>
          <p className="font-ui text-lg text-white/70">
            Generate, refine, and evolve visual intelligence inside your Creative Civilization OS.
          </p>
        </div>
        ...
        <div className="p-8 rounded-2xl bg-white/5 backdrop-blur-xl border border-white/10 shadow-[0_0_40px_rgba(0,0,0,0.4)] space-y-6">
          <h2 className="h2 mb-4">Visual Intelligence Core</h2>
          <p className="font-ui text-white/70 leading-relaxed">
            This is the multi‑layered visual engine that powers image synthesis,
            cosmic rendering, and crystalline world‑building inside Hegay OS Supreme.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <ActionCard
            ...
            description="Create new visual intelligence."
            href="/image-studio/generate"
          />
          <ActionCard
            title="Enhance Image"
            description="Refine and upscale your creations."
            href="/image-studio/enhance"
          />
          <ActionCard
            title="Image Library"
            description="Browse your generated visuals."
