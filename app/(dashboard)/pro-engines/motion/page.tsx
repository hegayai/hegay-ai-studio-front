export default function MotionEnginePro() {
  return (
    <div className="flex flex-col gap-12 max-w-6xl">
      ...
      <div>
        ...
        <p className="opacity-70 mt-2 leading-relaxed max-w-2xl">
          Cinematic motion engine for animatics, motion posters, scene motion,
          timeline‑synced sequences, and world‑building visual dynamics. This
          engine integrates with your universes, realms, timelines, and asset
          pipelines.
        </p>
      </div>
      {/* PRIMARY MODES */}
      ...
      {/* WORKSPACE */}
      <section>
        <h2 className="text-xl font-medium mb-4">Motion Workspace</h2>
        <div className="grid grid-cols-[2fr,1fr] gap-6">
          {/* LEFT: MOTION PANEL */}
          <div className="p-5 rounded-xl bg-white/5 border border-white/10 flex flex-col gap-4 min-h-[320px]">
            <div className="opacity-70 text-sm">
              Motion preview area (connect to your animation backend). This panel
              will display animatics, motion sequences, and timeline‑synced outputs.
            </div>
            <div className="mt-auto">
              ...
              <p className="opacity-50 text-[11px] mt-2">
                Motion Engine Pro supports multi‑step animation workflows,
                timeline‑aware generation, and routing outputs into your asset
                pipeline.
              </p>
            </div>
          </div>
          ...
          <div className="p-5 rounded-xl bg-white/5 border border-white/10 flex flex-col gap-4">
            ...
            <ul className="text-sm opacity-80 space-y-1">
              <li>• Mythic cinematic motion</li>
              <li>• Diaspora motion palette</li>
              <li>• Character‑driven motion</li>
              <li>• Realm environmental motion</li>
            </ul>
          </div>
        </div>
      </section>
      {/* SYSTEMS */}
      <section>
        <h2 className="text-xl font-medium mb-4">Motion Engine Systems</h2>
        <div className="grid grid-cols-3 gap-6">
          {[
            "Model Routing",
            "Motion Presets",
